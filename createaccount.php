...
// Check if personal details are set
...
if($_POST){
    ...
    if ($newpassword == $cpassword){
        ...
        if($result->num_rows == 1){
            ...
            $query = "INSERT INTO users (username, email, password_hash, first_name, last_name, address, phone_number) 
                     VALUES ('$email', '$email', '$hashed_password', '$fname', '$lname', '$address', '$tele')";
            ...
            if($database->query($query)){
                ...
                $error = '<label class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Error creating account: ' . $database->error . '</label>';
            }
        }
    } else {
